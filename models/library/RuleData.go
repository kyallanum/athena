...
func (rule_data *RuleData) GetSearchTermDataLen() int {
	return len(rule_data.st_data_collection)
}

func (rule_data *RuleData) GetSearchTermData(index int) SearchTermData {
	return rule_data.st_data_collection[index]
}

func (rule_data *RuleData) GetSummaryDataLen() int {
	return len(rule_data.summary_data)
}

func (rule_data *RuleData) GetSummaryData(index int) string {
